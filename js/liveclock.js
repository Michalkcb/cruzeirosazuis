...
// if needed (if you wanted abbreviated names for example).
	...
	var MonthsOfYear = new Array(12);
		MonthsOfYear[0] = "Styczeñ";
		MonthsOfYear[1] = "Luty";
		MonthsOfYear[2] = "Marzec";
		MonthsOfYear[3] = "Kwiecieñ";
		MonthsOfYear[4] = "Maj";
		MonthsOfYear[5] = "Czerwiec";
		MonthsOfYear[6] = "Lipiec";
		MonthsOfYear[7] = "Sierpieñ";
		MonthsOfYear[8] = "Wrzesieñ";
		MonthsOfYear[9] = "PaŸdziernik";
		MonthsOfYear[10] = "Listopad";
		MonthsOfYear[11] = "Grudzieñ";
