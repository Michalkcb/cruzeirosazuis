...
// if needed (if you wanted abbreviated names for example).
	...
	var MonthsOfYear = new Array(12);
		MonthsOfYear[0] = "Janeiro";
		MonthsOfYear[1] = "Fevereiro";
		MonthsOfYear[2] = "Março";
		MonthsOfYear[3] = "Abril";
		MonthsOfYear[4] = "Maio";
		MonthsOfYear[5] = "Junho";
		MonthsOfYear[6] = "Julho";
		MonthsOfYear[7] = "Agosto";
		MonthsOfYear[8] = "Setembro";
		MonthsOfYear[9] = "Outubro";
		MonthsOfYear[10] = "Novembro";
		MonthsOfYear[11] = "Dezembro";
